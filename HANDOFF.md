...
## 4. Two things that need your attention

### 4a. `frontend/AGENTS.md` is genuine Next.js output, not prompt injection — no action needed
...
### 4b. The `/create-pr` request cannot be fulfilled as-is
