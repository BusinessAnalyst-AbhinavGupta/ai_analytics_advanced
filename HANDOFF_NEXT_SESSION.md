...
## State
- **HEAD `83ef278` (CP-X7), tree clean.** Original `AI analytics/` folder untouched.
...
# standalone tests (121 = 118 pass + 3 live skipped); NOTE: plain `discover -s tests`
...
## What exists (`analytics_platform/`, 25 modules)
